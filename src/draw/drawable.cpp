...
template<> void Drawable<sceVu0FVECTOR>::DrawImpl(sceVu0FVECTOR* obj, const char* label, float min, float max) {
...
template<> void Drawable<sceVu0FMATRIX>::DrawImpl(sceVu0FMATRIX* obj, const char* label, float min, float max) {
