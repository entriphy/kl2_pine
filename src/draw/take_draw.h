...
template<> inline void Drawable<tagCOORD>::DrawImpl(tagCOORD *obj, const char *label, float min, float max) {
...
template<> inline void Drawable<ACTTBL>::DrawImpl(ACTTBL *obj, const char *label, float min, float max) {
...
template<> inline void Drawable<PARTS>::DrawImpl(PARTS *obj, const char *label, float min, float max) {
...
template<> inline void Drawable<MBLOCK>::DrawImpl(MBLOCK *obj, const char *label, float min, float max) {
...
template<> inline void Drawable<MOTION>::DrawImpl(MOTION *obj, const char *label, float min, float max) {
...
template<> inline void Drawable<SFXOBJ>::DrawImpl(SFXOBJ* obj, const char* label, float min, float max) {
